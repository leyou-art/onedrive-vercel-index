...
module.exports = {
  ...
  clientId: '1b925142-4ad9-498c-aac5-05d7d2d049d6',
  obfuscatedClientSecret: 'U2FsdGVkX19oiw621rkYc46kOnsIzMa4JkPmiKuP7lfzPNePtgXt33d4P4CATWQBsa9BQqXImtJVdyuLRKrbFg==',

  // The redirectUri is the URL that the user will be redirected to after they have authenticated with Microsoft Graph API.
  // Likewise, you would not need to change redirectUri if you are using your personal Microsoft account with OneDrive International.
  redirectUri: 'redis-cli -u redis://1b4f59d7a5ad4b39a8debd75b4cff042@global-regular-grouper-30233.upstash.io:30233',
